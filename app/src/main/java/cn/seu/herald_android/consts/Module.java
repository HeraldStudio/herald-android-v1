...
public class Module {
    ...
    public static AppModule card = new AppModule("cardextra",
            ...
            "MODULE_QUERY_CARDEXTRA", R.mipmap.ic_card, R.mipmap.ic_card, true, true);

    public static AppModule pedetail = new AppModule("pedetail",
            "跑操助手", "提供跑操次数及记录查询、早操预报以及跑操到账提醒服务",
            "MODULE_QUERY_PEDETAIL", R.mipmap.ic_pedetail, R.mipmap.ic_pedetail, true, true);

    public static AppModule curriculum = new AppModule("curriculum",
            "课表助手", "浏览当前学期的课表信息，并提供上课提醒服务",
            "MODULE_QUERY_CURRICULUM", R.mipmap.ic_curriculum, R.mipmap.ic_curriculum, true, true);

    public static AppModule experiment = new AppModule("experiment",
            "实验助手", "浏览当前学期的实验信息，并提供实验提醒服务",
            "MODULE_QUERY_EXPERIMENT", R.mipmap.ic_experiment, R.mipmap.ic_experiment, true, true);

    public static AppModule exam = new AppModule("exam",
            "考试助手", "查询个人考试安排，提供考试倒计时提醒服务",
            "MODULE_QUERY_EXAM", R.mipmap.ic_exam, R.mipmap.ic_exam, true, true);

    public static AppModule lecture = new AppModule("lecture",
            "人文讲座", "查看人文讲座听课记录，并提供人文讲座预告信息",
            "MODULE_QUERY_LECTURE", R.mipmap.ic_lecture, R.mipmap.ic_lecture, true, true);
    ...
    public static AppModule library = new AppModule("library",
            ...
            "MODULE_QUERY_LIBRARY", R.mipmap.ic_library, R.mipmap.ic_library, false, true);

    public static AppModule grade = new AppModule("grade",
            "成绩查询", "查询历史学期的科目成绩、学分以及绩点详情",
            "MODULE_QUERY_GRADE", R.mipmap.ic_grade, R.mipmap.ic_grade, false, true);

    public static AppModule srtp = new AppModule("srtp",
            "课外研学", "提供SRTP学分及得分详情查询服务",
            "MODULE_QUERY_SRTP", R.mipmap.ic_srtp, R.mipmap.ic_srtp, false, true);

    public static AppModule schoolbus = new AppModule("schoolbus",
            "校车助手", "提供可实时更新的校车班车时间表",
            "MODULE_QUERY_SCHOOLBUS", R.mipmap.ic_bus, R.mipmap.ic_bus, false, false);

    public static AppModule schedule = new AppModule("schedule",
            "校历查询 Web", "显示当前年度各学期的学校校历安排",
            "http://heraldstudio.com/static/images/xiaoli.jpg", R.mipmap.ic_schedule, R.mipmap.ic_schedule, false, false);

    public static AppModule quanyi = new AppModule("quanyi",
            "权益服务 Web", "向东大校会权益部反馈投诉信息",
            "https://jinshuju.net/f/By3aTK", R.mipmap.ic_quanyi, R.mipmap.ic_quanyi, false, false);
