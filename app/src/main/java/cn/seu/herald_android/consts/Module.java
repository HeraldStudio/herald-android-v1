...
public class Module {
    ...
    public static AppModule express = new AppModule("express",
            ...
            "MODULE_EXPRESS", R.mipmap.ic_express, false, true);
    ...
    public static AppModule quanyi = new AppModule("quanyi",
            ...
            "https://jinshuju.net/f/By3aTK", R.mipmap.ic_quanyi, false, false);
...
//                "MODULE_TOPIC", R.drawable.ic_build_purple_a700_24dp, false);
    ...
    public static AppModule moduleManager = new AppModule("",
            "模块管理", "管理各模块的显示/隐藏状态",
            "MODULE_MANAGER", R.mipmap.ic_add, true, false);
