...
class PedetailRecordModel {
    ...
    public static Comparator<PedetailRecordModel> yearMonthComparator = (e1, e2) -> {
    ...
    public PedetailRecordModel(JObj obj, int count) {
        ...
        isValid = obj.$s("sign_effect").equals("有效");
        exerciseCount = count;
    }
