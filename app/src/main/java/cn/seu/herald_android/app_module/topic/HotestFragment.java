...
public class HotestFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        RecyclerView rv = (RecyclerView) inflater.inflate(
                R.layout.mod_que_topic_fragment_hotest, container, false);
        listener.deliveRecycler(rv);
    ...
    public List<String> getRandomSublist(String[] array, int amount) {
    ...
    public static class SimpleStringRecyclerViewAdapter
        ...
        public static class ViewHolder extends RecyclerView.ViewHolder {
            ...
            public ViewHolder(View view) {
                super(view);
                mView = view;
                mTextView = (TextView) view.findViewById(R.id.text_comment_user);
            }
