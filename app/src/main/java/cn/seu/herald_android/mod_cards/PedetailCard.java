...
import cn.seu.herald_android.mod_query.pedetail.PedetailBlockLayout;
    ...
    public static CardsModel getCard() {
        ...
        try {
            ...
            if (record.contains(todayStamp)) {
                ...
                item.attachedView.add(new PedetailBlockLayout(AppContext.currentContext.$get(), count, Math.max(0, 45 - count), remain));
