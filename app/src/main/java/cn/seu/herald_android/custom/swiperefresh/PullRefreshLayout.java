...
public class PullRefreshLayout extends ViewGroup {
    ...
    private SwipeRefreshHeaderView mRefreshView;
    ...
    public PullRefreshLayout(Context context, AttributeSet attrs) {
        ...
        mColorSchemeColors = new int[]{Color.WHITE};

        mRefreshView = new SwipeRefreshHeaderView(context);
        setRefreshStyle();
        mRefreshView.setLayoutParams(new LayoutParams(-1, -2));
...
//        mRefreshView.bringToFront();
        ...
        mRefreshView.setLayoutParams(new LayoutParams(-1, mCurrentOffsetTop));
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        mRefreshView.layout(left, top, left + width - right, top + mRefreshView.getLayoutParams().height);
    }
