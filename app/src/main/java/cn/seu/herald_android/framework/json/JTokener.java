...
public class JTokener {
     ...
     *
     * @return a {@link JObj}, {@link JArr}, String, Boolean,
     * Integer, Long, Double or {@link JObj#NULL}.
     ...
     */
    private JObj readObject() throws JSONException {
     ...
     */
    private JArr readArray() throws JSONException {
