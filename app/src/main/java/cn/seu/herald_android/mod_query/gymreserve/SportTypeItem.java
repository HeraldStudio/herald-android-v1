...
public class SportTypeItem implements Serializable{
    ...
    public SportTypeItem(String name, int allowHalf, int fullMinUsers, int fullMaxUsers, int halfMinUsers, int halfMaxUsers, int sportId) {
        this.name = name;
    ...
    public static ArrayList<SportTypeItem> transformJSONtoArrayList(JSONArray jsonArray) throws JSONException {
